...
* the tested Firmware version.
  ...
  * [x] 5.20(fw.5.20) - D type, ganymede 생산 등록 버전.(https://github.com/elpusk/product.lpu237/tree/d_magtek/firmware)
...
1. <u>Device tab</u>
    ...
    * "Selects Device" 실행시, 선택된 장비의 기능에 맞게 tab 이 표시.
      ...
      + [x] F00NU type fw.5.20 은 Common, IB-tag tab 표시.
...
8. <u>IB-remove tab</u> - i-button 제거시, 전송되는 키.
    * [x] fw.5.21 이상 (ganymede) 또는 fw.3.22 이상(callisto) 에서만 표시.
    * [x] 키 20개까지 입력.
